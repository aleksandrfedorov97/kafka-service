...
public class KafkaConfiguration {
    ...
    @Value("${app.kafka.groups.orderStatusGroupId}")
    private String orderStatusGroupId;

    @Bean
    ProducerFactory<String, OrderEvent> orderEventProducerFactory(ObjectMapper objectMapper) {
    ...
    public ConsumerFactory<String, OrderStatus> orderStatusConsumerFactory(ObjectMapper objectMapper) {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, orderStatusGroupId);
